...
const LearningGridArray = [
    {
        ...
        highlightedTextL: "Anyone, Anywhere",
    ...
    <div className='grid mx-auto grid-cols-1 lg:grid-cols-4 mb-10 p-5 lg:w-fit'>
        {
            LearningGridArray.map((card, index) => {
                return (
                    ...
                    className={`
                    ${
                        index === 0 ? "lg:col-span-2 lg:h-[280px] p-5": "col-span-1"} 
                    ${
                            ...
                            (
                                <div className='lg:w-[90%] flex flex-col pb-5 gap-3'>
                                    <div className='text-4xl font-semibold'>
                                        <h1>{card.heading}</h1>
                                        <HighlightText text={card.highlightedTextL} />
                                    </div>
                                    <p
                                    ...
                                    <div className='w-fit'>
                                        <CTAButton 
                                        active={true} linkto={card.BtnLink}
                                        >
                                            {card.BtnText}
                                        </CTAButton>
                                    </div>
